<template>
                ...
                <el-dialog v-model="dialogVisible" title="添加员工" width="30%">
                    <el-form :model="addEmployeeInfo" label-width="120px" :inline="true">
                        ...
                        <el-form-item required label="年龄：">
                            <el-input v-model="addEmployeeInfo.age" class="add-form-style"
    ...
    <el-card>
        <el-table :data="tableData" style="width: 100%;margin-bottom: 15px;" height="600" border>
            ...
            <el-table-column prop="employeeName" label="员工姓名" width="260" />
            <el-table-column prop="age" label="年龄" width="170" />
            <el-table-column prop="gender" label="性别" width="170" />
            <el-table-column prop="workTime" label="已工作时间" width="200" />
            <el-table-column prop="salary" label="薪水" width="200" />
